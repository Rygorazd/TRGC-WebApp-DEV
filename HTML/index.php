...
<img alt="Image html" width="90%" height="90%" style="max-height:500px;max-width:500px;" src="../IMG/courtney-cook-SsIIw_MET0E-unsplash.jpg" />
                </div>
...
<div class="row justify-content-center" style="padding-top:10px;">
    <a href="booking.php" class="btn btn-primary btn-lg btn-depth btn-arrow" role="button">Book A TEE</a>
                        </div>
                    </div>
                </div>
        </div>
